<?php
	...
	$query = "UPDATE proveedores SET nombre='$nombre', apellido='$apellido', empresa='$empresa', nit='$nit', direccion='$direccion', email='$email' WHERE idproveedor = '$id'";
		...
		<div class="container">
			<div class="row">
				<div class="row" style="text-align:center">
					...
					<a href="listaproveedores.php" class="btn btn-primary">Regresar</a>
