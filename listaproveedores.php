...
<div class="container">
<div class="form_top">
    <a href="buscadorproveedores.php" class="btn btn-primary" type="submit" name="enviar" value="buscar" >Buscar Proveedor</a>
    </form>
</div>
<div class="container">
        <div class="form_top">
    <h1 align="center">Lista de Proveedores</h1>
      ...
      <table class="table table-striped">
          ...
          <tr>
              ...
              <td scope="col"><strong>Empresa</strong></td>
              <td scope="col"><strong>Nit</strong></td>
              <td scope="col"><strong>Direccion</strong></td>
          ...
          ?>
          <tr>
              <th scope="row"><?php echo $mostrar['idproveedor'] ?></th>
              <td><?php echo $mostrar['nombre'] ?></td>
              <td><?php echo $mostrar['apellido'] ?></td>
              <td><?php echo $mostrar['empresa'] ?></td>
              <td><?php echo $mostrar['nit'] ?></td>
              <td><?php echo $mostrar['direccion'] ?></td>
              <td><a href="modificarproveedor.php?id=<?php echo $mostrar['idproveedor']; ?>"><span class="icon-pencil"></span></a></td>
              <td><a href="#" data-href="eliminarproveedor.php?id=<?php echo $mostrar['idproveedor']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="icon-trash"></span></a></td>
          </tr>
