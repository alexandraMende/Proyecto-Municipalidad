...
<div class="container">
<div class="form_top">
    <a href="buscadorproductos.php" class="btn btn-primary" type="submit" name="enviar" value="buscar" >Buscar Producto</a>
    </form>
</div>
       <div class="container">
        <div class="form_top">
    <h1 align="center">Lista de productos</h1>
      ...
      <table class="table table-striped">
          <thead>
          <tr>
              <td scope="col"><strong>Id del producto</strong></td>
              <td scope="col"><strong>Nombre</strong></td>
              <td scope="col"><strong>Cantidad en existencias</strong></td>
              <td scope="col"><strong>Precio de venta</strong></td>
              <td scope="col"><strong>Id del proveedor</strong></td>
          ...
          ?>
          <tr>
              <td scope="row"><?php echo $mostrar['idproducto'] ?></td>
              <td><?php echo $mostrar['nombre'] ?></td>
              <td><?php echo $mostrar['cantidad'] ?></td>
              <td><?php echo $mostrar['precio'] ?></td>
              <td><?php echo $mostrar['idproveedor'] ?></td>
              <td><a href="modificarproducto.php?id=<?php echo $mostrar['idproducto']; ?>"><span class="icon-pencil"></span></a></td>
              <td><a href="#" data-href="eliminarproducto.php?id=<?php echo $mostrar['idproducto']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="icon-trash"></span></a></td>
          </tr>
