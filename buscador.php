...
<body background="img/logo.png">
    ...
    <label for="inputBuscar" class="buscador">Buscar Marca</label>
    <input type="text" name="buscar" id="buscar" class="form-control" placeholder="Ingrese Marca que desea buscar" required autofocus>
    ...
    if(isset($_GET['enviar'])) {
        ...
        $consulta = $conexion->query("SELECT * FROM marcas WHERE nombre LIKE '%$buscar%'");
