...
<div class="container">
    <h1 align="center">Modificar registro</h1>
			...
			<form class="form-horizontal" method="POST" action="actualizarmarcas.php" autocomplete="off">
				...
				<input type="hidden" id="idmarcas" name="idmarcas" value="<?php echo $mostrar['idmarcas']; ?>" />
				
				</div>
				
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<a href="listademarcas.php" class="btn btn-default">Regresar</a>
