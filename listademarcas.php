...
<div class="container">
<div class="form_top">
    <a href="buscador.php" class="btn btn-primary" type="submit" name="enviar" value="buscar" >Buscar Marcas</a>
</div>
<div class="container">
        <div class="form_top">
    <h1 align="center">Lista de Marcas</h1>
      ...
      <table class="table table-striped">
          <thead>
          <tr>
              <td scope="col"><strong>Idmarcas</strong></td>
          ...
          ?>
          <tr>
              <th scope="row"><?php echo $mostrar['idmarcas'] ?></th>
              <td><?php echo $mostrar['nombre'] ?></td>
              <td><a href="modificarmarca.php?id=<?php echo $mostrar['idmarcas']; ?>"><span class="icon-pencil"></span></a></td>
              <td><a href="#" data-href="eliminarmarca.php?id=<?php echo $mostrar['idmarcas']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="icon-trash"></span></a></td>
          </tr>
