<?php
	...
	$query = "UPDATE login SET usuario='$usuario', contraseña='$contraseña', estado='$estado', idempleado='$idempleado' WHERE idlogin = '$id'";
		...
		<div class="container">
			<div class="row">
				<div class="row" style="text-align:center">
					...
					<a href="listadeusuarios.php" class="btn btn-primary">Regresar</a>
