...
<body background="img/logo.png">
    ...
    <label for="inputBuscar" class="buscador">Buscar proveedor</label>
    <input type="text" name="buscar" id="buscar" class="form-control" placeholder="Ingrese proveedor que desea buscar" required autofocus>
    ...
    if(isset($_GET['enviar'])) {
        ...
        $consulta = $conexion->query("SELECT * FROM proveedores WHERE nombre LIKE '%$buscar%'");
